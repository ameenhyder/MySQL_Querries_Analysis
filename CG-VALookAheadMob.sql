...
Set @endDate = '2019-07-10';
CALL `smexplorerdata`.`CG_Consistency_IB`('atentotfn_mobilesales.callgroups', 'iscurrent=1', 'atentotfn_mobilesales.smetable_combined',  'INSCOPE_FLAG=1' , 'Is_sale', @startDate, @endDate,'smeData');
...
Where IsCurrent = 1 and V_CALLTIME >= @startDate and V_CALLTIME < @endDate and INSCOPE_FLAG = 1 and Site = 'SBC'# and on_off = 0
...
Select First_Call_Mobile_OTH1, count(*)
From `atentotfn_mobilesales.smetable_combined`
Where calltime >= '2019-05-01' and site = 'SBC' and inscope_flag = 1
Group By 1